...
import { Scale, TrendingUp, TrendingDown, AlertTriangle, CheckCircle, Download } from 'lucide-react';
    ...
    <div>
      ...
      <div className="kpi-grid">
        {[
          ...
          { label: 'Reorder Status', value: kpis.reorder_alert ? '⚠ REORDER' : '✔ OK', icon: kpis.reorder_alert ? AlertTriangle : CheckCircle, color: kpis.reorder_alert ? 'var(--red)' : 'var(--green)' },
