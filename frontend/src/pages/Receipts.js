        ...
        <div className="card-body" style={{ paddingTop: 12, paddingBottom: 12 }}>
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ position: 'relative', flex: 1, minWidth: 160 }}>
              ...
              <input className="form-control" style={{ paddingLeft: 30 }} placeholder="Search supplier…" value={search} onChange={e => setSearch(e.target.value)} />
            </div>
      ...
      <div className="card">
        <div className="table-wrap">
          {loading ? (
            ...
            <div className="empty-state"><div className="empty-state-icon">📦</div><h3>No receipts yet</h3><p>Click "Record Delivery" to add your first entry.</p></div>
          ) : (
            <table>
              <thead>
                <tr><th>Date</th><th>GRN No.</th><th>Supplier</th><th>Qty (Bags)</th><th>Unit Cost</th><th>Total Cost</th><th>Del. Note</th><th>Condition</th><th>Actions</th></tr>
              </thead>
              <tbody>
                {receipts.map(r => (
                  <tr key={r.id}>
              ...
              <tfoot>
                <tr className="tfoot-row">
                  ...
                  <td>{fmt.number(receipts.reduce((s,r) => s+r.quantity, 0))} bags</td>
                  <td></td>
